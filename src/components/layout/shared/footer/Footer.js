...
const Footer = () => {
    ...
    return (
        <div className="w-full bg-white px-8 max-[500px]:px-4 pt-12 pb-2 flex flex-col gap-8 relative">
            <div className="bg-[#F4F4F4] bg-[url('/assets/images/pre-footer.svg')] bg-contain bg-no-repeat bg-center h-10"></div>
