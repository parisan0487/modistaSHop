...
const AddProductsToDB = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            variants: [
                { color: 'خاکستری', size: 'xl', stock: 10 },
            ],
        },
        {
            id: 12,
