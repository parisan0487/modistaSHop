            ...
            <div className="w-full py-4 border-t border-zinc-500/30 flex items-center justify-center gap-6">
              <span
                ...
                className={`${
                  ...
                  "p-2 bg-gray-500/10 rounded-2xl"
                }`}
              >
                مردانه
              </span>
              <span
                ...
                className={`${
                  category === "پوشاک زنانه" && "p-2 bg-gray-500/10 rounded-2xl"
                }`}
              >
                زنانه
              </span>
              ...
              <span
                ...
                className={`${
                  category === "پوشاک ورزشی" && "p-2 bg-gray-500/10 rounded-2xl"
                }`}
              >
                ورزشی
              </span>
        ...
        <div className="w-full h-full flex flex-col justify-between p-4">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div className="p-3 rounded-2xl border border-black/20 flex items-center justify-center gap-2">
              <span className="!text-black/60 font-extrabold">
                دانلود اپلیکیشن
              </span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
