                ...
                <div className='flex flex-row justify-between'>
                    ...
                    <div className='flex flex-row gap-3'>
                        <button onClick={handleCopy} className='p-4 bg-[#F7F7F7] rounded-xl cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M12.72 4.6275C14.22 5.67 15.255 7.3275 15.465 9.24" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M2.61743 9.27749C2.81243 7.37249 3.83243 5.71499 5.31743 4.66499" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M6.14258 15.705C7.01258 16.1475 8.00258 16.395 9.04508 16.395C10.0501 16.395 10.9951 16.17 11.8426 15.7575" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M9.04496 5.775C10.1965 5.775 11.13 4.84151 11.13 3.69C11.13 2.53848 10.1965 1.605 9.04496 1.605C7.89345 1.605 6.95996 2.53848 6.95996 3.69C6.95996 4.84151 7.89345 5.775 9.04496 5.775Z" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M3.6226 14.94C4.77411 14.94 5.7076 14.0065 5.7076 12.855C5.7076 11.7035 4.77411 10.77 3.6226 10.77C2.47108 10.77 1.5376 11.7035 1.5376 12.855C1.5376 14.0065 2.47108 14.94 3.6226 14.94Z" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M14.3775 14.94C15.529 14.94 16.4625 14.0065 16.4625 12.855C16.4625 11.7035 15.529 10.77 14.3775 10.77C13.226 10.77 12.2925 11.7035 12.2925 12.855C12.2925 14.0065 13.226 14.94 14.3775 14.94Z" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg></button>
                        <button className='p-4 bg-[#F7F7F7] rounded-xl cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M9.465 15.6075C9.21 15.6975 8.79 15.6975 8.535 15.6075C6.36 14.865 1.5 11.7675 1.5 6.5175C1.5 4.2 3.3675 2.325 5.67 2.325C7.035 2.325 8.2425 2.985 9 4.005C9.7575 2.985 10.9725 2.325 12.33 2.325C14.6325 2.325 16.5 4.2 16.5 6.5175C16.5 11.7675 11.64 14.865 9.465 15.6075Z" stroke="#AFAFAF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg></button>
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex gap-3">
                        {colors.map((color) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all ${selectedColor === color
                ...
                <div className='w-[20.5rem] h-[14.5rem] bg-[#F7F7F7] rounded-xl p-3 '>
                    <div className='w-full rounded-xl p-3 bg-white mx-auto text-[#6E6E6E] flex flex-row gap-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z" stroke="#545454" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M7.75 12L10.58 14.83L16.25 9.17" stroke="#545454" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                        <p><span>{stock} </span>عدد در انبار </p>
                    </div>
                    ...
                    <button disabled={stock == 0} onClick={handelAddToBasket} className={`w-full p-4 h-[3rem] ${stock >= 1 ? "bg-[#FD5504] " : "bg-[#FAA67D] "} rounded-2xl mt-6 text-center text-white font-bold flex items-center justify-center cursor-pointer`}>
