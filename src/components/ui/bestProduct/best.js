                  ...
                  <div className="flex flex-col items-end">
                    {product.oldPrice && (
                      <div className="flex items-center gap-1 mb-1">
                        <span className="text-xs text-gray-400 line-through">{toPersianDigits(product.oldPrice)}</span>
                        {product.discount && (
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-lg font-semibold text-black">{toPersianDigits(product.price)}</span>
        ...
        <div className="flex justify-end items-center mb-6 w-72 ml-12">
          <div className="text-end">
            <h2 className="text-[32px] leading-[200%] text-[#2B2727]">
              <span className="font-extrabold text-black">پرفروش‌ترین</span> <span className="font-light">محصولات</span>
            </h2>
            ...
            <div className="flex flex-col items-end leading-tight">
              ...
              <div className="flex items-center gap-5 mt-5">
                ...
                <div className="relative flex h-full gap-0 mb-16 mr-28">
                  <Image src="/img/Ellipse-11.png" className="w-[52px] z-10" width={49} height={49} alt="تصویر ۱" />
                  <Image
