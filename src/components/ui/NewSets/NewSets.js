...
import slideToleftI from "../../../../public/assets/slide-arrow-1.svg";
import slideToRithI from "../../../../public/assets/slide-arrow.svg";
    ...
    return (
        <div className='flex flex-col items-center justify-center text-[#2D2929] w-full my-12 bg-[#F7F7F7]'>
            ...
            <div className='relative w-full max-w-[1100px] flex items-center justify-center my-8'>
                ...
                <button
                    onClick={handlePrev}
                    className='absolute left-4 z-50 p-3 bg-white rounded-xl shadow-md'
                >
                ...
                <button
                    onClick={handleNext}
                    className='absolute right-4 z-50 p-3 bg-white rounded-xl shadow-md'
                >
