            ...
            {enhancedProducts.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex gap-1 mt-1">
                    {imagesArray.map((img, i) => (
                      <div
                        ...
                        onClick={(e) => handleThumbnailClick(product.id, img, e)}
                      >
                        <img
                          src={img}
                          alt={`thumb-${i}`}
                  ...
                  <Link href={`/product/${product.id}`} passHref>
                    <h2 className="text-center font-medium text-gray-800 cursor-pointer hover:text-orange-500">
                      {product.name}
                    </h2>
                  </Link>
                  ...
                  <div className="flex justify-between items-center mt-auto">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="25" height="34" viewBox="0 0 25 24" fill="none" className="stroke-white group-hover:stroke-[#fff]">
                        <path d="M20 9.5L19.2896 6.89465C19.0157 5.89005 18.8787 5.38775 18.5978 5.00946C18.318 4.63273 17.9378 4.34234 17.5008 4.17152C17.0619 4 16.5413 4 15.5 4M5 9.5L5.7104 6.89465C5.98432 5.89005 6.12128 5.38775 6.40221 5.00946C6.68199 4.63273 7.06216 4.34234 7.49922 4.17152C7.93808 4 8.45872 4 9.5 4" strokeWidth="1.5"></path>
                        <path d="M9.5 4C9.5 3.44772 9.94772 3 10.5 3H14.5C15.0523 3 15.5 3.44772 15.5 4C15.5 4.55228 15.0523 5 14.5 5H10.5C9.94772 5 9.5 4.55228 9.5 4Z" strokeWidth="1.5"></path>
